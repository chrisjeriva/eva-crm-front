...
describe('Component Tests', () => {
  describe('Prospecto Management Component', () => {
    let comp: ProspectoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProspectoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.prospectos?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
